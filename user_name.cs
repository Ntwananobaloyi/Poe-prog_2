    ...
    {//start of class
        ...
        {//start of
            ...
            {//start of if
                ...
                error_method("ChatBot", "Hey " + name + " Welcome to the Cyber Awareness Chatbot. I help users stay safe online by providing guidance on passwords, phishing," +
                    " VPNs, malicious threats, fraud, hacked accounts, firewalls, and cybersecurity awareness. My purpose is to educate and protect users from cyber risks.\r\n."
                    , chats);
